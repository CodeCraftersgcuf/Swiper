...
const AbsolutePart = () => {
    return (
        <div className='product-card-check absolute bg-white p-4 top-[9%] right-[4.5rem] z-50 w-[24rem] h-[33rem] border border-gray-400 rounded-lg overflow-scroll scrollbar-hide'>
